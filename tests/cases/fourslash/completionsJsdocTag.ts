...
verify.completions({ marker: "", includes: { name: "@property"/* , text: "@property" */, kind: "jsDocTag" } });
    ...
    if (marker) {
        ...
        switch (n) {
            ...
            case 81: case 82:
                completionOpt = {
                    marker,
                    includes: ["@link", "@linkcode", "@linkplain", "@tutorial"]
                    // TODO: cannot pass "exact", why?
                    // exact: ["@link", "@linkcode", "@linkplain", "@tutorial"]
